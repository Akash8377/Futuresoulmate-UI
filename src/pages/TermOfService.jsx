    ...
    <div className="container py-5">
      <div className="row justify-content-center">
        <div className="col-lg-10 col-xl-8">
          ...
          <div className="card shadow-sm mb-4">
            <div className="card-body">
              <h3 className="h4 text-primary mb-3">2. Eligibility</h3>
          ...
          <div className="card shadow-sm mb-4">
            <div className="card-body">
              <h3 className="h4 text-primary mb-3">3. Membership and Subscription</h3>
          ...
          <div className="card shadow-sm mb-4">
            <div className="card-body">
              <h3 className="h4 text-primary mb-3">4. User Conduct and Content</h3>
          ...
          <div className="card shadow-sm mb-4">
            <div className="card-body">
              <h3 className="h4 text-primary mb-3">5. Privacy and Data Protection</h3>
              <p>
          ...
          <div className="card shadow-sm mb-4">
            <div className="card-body">
              <h3 className="h4 text-primary mb-3">6. Intellectual Property</h3>
              <p>
          ...
          <div className="card shadow-sm mb-4">
            <div className="card-body">
              <h3 className="h4 text-primary mb-3">7. Disclaimer of Warranties</h3>
              <p>
          ...
          <div className="card shadow-sm mb-4">
            <div className="card-body">
              <h3 className="h4 text-primary mb-3">8. Limitation of Liability</h3>
              <p>
          ...
          <div className="card shadow-sm mb-4">
            <div className="card-body">
              <h3 className="h4 text-primary mb-3">9. Changes to Terms</h3>
              <p>
