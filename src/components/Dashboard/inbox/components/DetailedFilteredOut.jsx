...
function DetailedFilteredOut({ filteredOut, fetchPreferenceData }) {
  ...
  const totalPages = Math.ceil(filteredOut.length / itemsPerPage);

  // Get current page data
  const startIndex = currentPage * itemsPerPage;
  const currentReceivers = filteredOut.slice(startIndex, startIndex + itemsPerPage);
      ...
      <div className="profile-request">
        <div className="card-profile">
          <div className="Filtered-out">
            <img src="images/filtredout.jpg" alt="No filtered invitations" />
      ...
      {totalPages > 1 && (
        <div className="pagination-wrapper d-flex justify-content-center align-items-center mt-4">
          ...
          <span className="pagination-info mx-3">
            Showing {startIndex + 1}-{Math.min(startIndex + itemsPerPage, filteredOut.length)} of {filteredOut.length}
          </span>
